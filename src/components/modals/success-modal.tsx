    ...
    <ModalLayout>
      <div className="modal__wrapper">
        <div className="success-modal">
          <div className="success-modal__header-wrapper">
            <h2 className="success-modal__header">Форма успешно отправлена</h2>
            <div className="check-mark__wrapper">
              <svg
            ...
            <button
              ...
              id="button-to-main"
              className="modal__button-to-main"
            >
              На главную
            </button>
          </div>
